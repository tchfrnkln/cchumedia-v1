...
const Socials = () => {
  ...
  return (
    <div className='max-w-screen w-full flex justify-between items-center text-black'>
        ...
        <div className='flex gap-1 flex-col md:flex-row hover:cursor-pointer text-xs'>
