...
export const navLinks = [
    ...
    { page: 'kits', label: '🚀 Starter Kits', url:'start' },
    { page: 'campaign', label: '🗳️ Campaign', url:'campaign' },
    { page: 'publishing', label: '📚 Publishing', url:'publishing' },
    // { page: 'design-tool', label: '🎨 Design Online' },
    { page: 'earn', label: '💰 Earn', url:'earn' },
    // { page: 'track', label: '📦 Track' },
    // { page: 'faq', label: '❓ FAQ' },
    { page: 'contact', label: '📞 Contact', url:'contact' }
  ];
